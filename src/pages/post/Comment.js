...
// function Comment({postId, comments, updateComments, getPost}) {
...
//       <CommentForm state={state} setState={setState} postId={postId} comments={comments} updateComments={updateComments} getPost={getPost}/>
//     </div>
//   );
// }
...
class Comment extends Component {
  ...
  isValid = () => {
    ...
    if (!text.length > 0 || text.length > 150) {
      this.setState({
        error: "Comment cannot be empty and should be less than 150 characters long",
      });
      return false;
    }
    return true;
                        ...
                        isAuth().user._id === comment.postedBy._id && (
                          <>
                            <span
                              ...
                              className=" border border-danger text-danger float-right mr-1"
                            >
                              Remove
                            </span>
                          </>
